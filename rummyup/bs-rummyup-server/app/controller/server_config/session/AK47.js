...
class AK47Controller extends Controller {
    async index() {
        const { ctx } = this;
    ...
    async form() {
        ...
        if (uploadData) {
            let result = await ctx.service.session.notifyGameServerByAK47(uploadData);
