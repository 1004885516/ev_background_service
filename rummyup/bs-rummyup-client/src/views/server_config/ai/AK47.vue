...
<script>
    ...
    export default {
        ...
        data() {
            return {
                uploadURL: '/upload_file_ai_ak47',
                saveURL: '/ai_ak47_save',
                getURL: '/ai_ak47',
                uploadData: { jsontype: 13, serverType: 'Ak47' },
                isPaging: true,
                curTemplateData: {
                    Page: 0, Type: 0, OfficeIsBig: 0, PolicyRank: 0, PlayerPolicy: [ 0, 0, 0, 0, 0, 0 ], OfficePolicy: [ 0, 0, 0, 0, 0, 0 ], OfficeRejectCompare: [ 0, 0, 0, 0, 0, 0 ], OtherRejectCompare: [ 0, 0, 0, 0, 0, 0 ],
                    OfficeRobot: [
