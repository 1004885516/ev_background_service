<template>
    <el-card class="box-card">
        <el-row :gutter="20" class="mb-20">
            <h3><strong>HighestJoker控牌配置</strong></h3>
        </el-row>
        <el-row class="mb-20">
            <el-col :span="6">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                uploadURL: '/upload_file_ai_hj',
                saveURL: '/ai_highest_joker_save',
                getURL: '/ai_highest_joker',
                uploadData: { jsontype: 15, serverType: 'HighJoker' },
                isPaging: true,
                curTemplateData: {
                    Page: 0, OfficeIsBig: 0, PolicyRank: 0, PlayerPolicy: [ 0, 0, 0, 0, 0, 0 ], OfficePolicy: [ 0, 0, 0, 0, 0, 0 ], OfficeRejectCompare: [ 0, 0, 0, 0, 0, 0 ], OtherRejectCompare: [ 0, 0, 0, 0, 0, 0 ],
                    OfficeRobot: [
