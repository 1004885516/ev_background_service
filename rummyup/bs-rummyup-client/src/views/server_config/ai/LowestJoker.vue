<template>
    <el-card class="box-card">
        <el-row :gutter="20" class="mb-20">
            <h3><strong>LowestJoker控牌配置</strong></h3>
        </el-row>
        <el-row class="mb-20">
            <el-col :span="6">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                uploadURL: '/upload_file_ai_lj',
                saveURL: '/ai_lowest_joker_save',
                getURL: '/ai_lowest_joker',
                uploadData: { jsontype: 14, serverType: 'LowJoker' },
                isPaging: true,
                curTemplateData: {
                    Page: 0, OfficeIsBig: 0, PolicyRank: 0, PlayerPolicy: [ 0, 0, 0, 0, 0, 0 ], OfficePolicy: [ 1, 0, 0, 0, 0, 0 ], OfficeRejectCompare: [ 1, 0, 0, 0, 0, 0 ], OtherRejectCompare: [ 1, 0, 0, 0, 0, 0 ],
                    OfficeRobot: [
