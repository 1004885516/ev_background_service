<template>
    <el-card class="box-card">
        <el-row :gutter="20" class="mb-20">
            <h3><strong>HighestJoker场次配置</strong></h3>
        </el-row>
        <el-row class="mb-20">
            <el-col :span="6">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                uploadURL: '/upload_file_hj',
                saveURL: '/session_highest_joker_save',
                getURL: '/session_highest_joker',
                uploadData: { jsontype: 11, serverType: 'HighJoker' },
                isPaging: false,
            }
        },
    };
