<template>
    <el-card class="box-card">
        <el-row :gutter="20" class="mb-20">
            <h3><strong>二人Rummy场次配置</strong></h3>
        </el-row>
        <el-row class="mb-20">
            <el-col :span="6">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                uploadURL: '/upload_file_str',
                saveURL: '/session_rummy_2p_save',
                getURL: '/session_rummy_2p',
                uploadData: { jsontype: 7, serverType: 'Rummy2User' },
                isPaging: false,
            }
        },
    };
