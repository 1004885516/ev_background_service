<template>
    <el-card class="box-card">
        <el-row :gutter="20" class="mb-20">
            <h3><strong>TeenPatti(speed)场次配置</strong></h3>
        </el-row>
        <el-row class="mb-20">
            <el-col :span="6">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                uploadURL: '/upload_file_stp',
                saveURL: '/session_teenpatti_s_save',
                getURL: '/session_teenpatti_s',
                uploadData: { jsontype: 8, serverType: 'Quicktp' },
                isPaging: false,
            }
        },
    };
