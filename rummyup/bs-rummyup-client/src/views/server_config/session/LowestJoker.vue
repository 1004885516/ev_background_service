<template>
    <el-card class="box-card">
        <el-row :gutter="20" class="mb-20">
            <h3><strong>LowestJoker场次配置</strong></h3>
        </el-row>
        <el-row class="mb-20">
            <el-col :span="6">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                uploadURL: '/upload_file_lj',
                saveURL: '/session_lowest_joker_save',
                getURL: '/session_lowest_joker',
                uploadData: { jsontype: 10, serverType: 'LowJoker' },
                isPaging: false,
            }
        },
    };
