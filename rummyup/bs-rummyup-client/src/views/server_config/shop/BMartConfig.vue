        ...
        <el-row style="margin-top: 20px">
            <el-card class="box-card" style="width: 100%" shadow="never">
                ...
                <el-row style="margin-top: 30px">
                    ...
                    <el-col :span="2" style="text-align: right"><span>ChannelCode :</span></el-col>
                    <el-col :span="4" style="text-align: left"><span>{{ TemplateData[0].ChannelCode }}</span></el-col>
                    <el-col :span="2" style="text-align: right"><span>Key :</span></el-col>
    ...
    export default {
        ...
        data() {
            return {
                TemplateData: [
                    {
                        MinPayout: 0, MaxPayout: 0, PayoutCount: 0, Retained: 0, Tax: 0, ChannelCode: 0, Key: 0,
                        ExtraConfig: [{ Minimum: 0, Maximum: 0, FirstExtra: 0, Extra: 0, BeginTime: 0, EndTime: 0 }],
                        ItemList: [{ SerialNumber: 0, Count: 0, Icon: 0, IsHot: 0 }],
                    }
                ],
                uploadURL: '/upload_file_scb',
                saveURL: '/shop_config_bmart_save',
                getURL: '/shop_config_bmart',
                uploadData: { jsontype: 20 },
                isPaging: false,
            }
        },
    };
