    ...
    <el-card class="box-card">
        ...
        <el-row style="margin-top: 20px">
            <el-card class="box-card" style="width: 100%" shadow="never">
                <el-row>
                    <el-col :span="3" style="text-align: right"><span>单次最小提现金额 :</span></el-col>
                    <el-col :span="4" style="text-align: left"><span>{{ TemplateData[0].MinPayout }}</span></el-col>
                    <el-col :span="3" style="text-align: right"><span>单次最大提现金额 :</span></el-col>
                    <el-col :span="4" style="text-align: left"><span>{{ TemplateData[0].MaxPayout }}</span></el-col>
                    <el-col :span="3" style="text-align: right"><span>每日提现次数上限 :</span></el-col>
                    <el-col :span="4" style="text-align: left"><span>{{ TemplateData[0].PayoutCount }}</span></el-col>
                    <el-col :span="3" style="text-align: right"><span>提现留存 :</span></el-col>
                ...
                <el-row style="margin-top: 30px">
                    ...
                    <el-col :span="1" style="text-align: left"><span>{{ TemplateData[0].Tax }}</span></el-col>
                    <el-col :span="2" style="text-align: right"><span>机构编号 :</span></el-col>
                    <el-col :span="1" style="text-align: left"><span>{{ TemplateData[0].OrgNo }}</span></el-col>
                    <el-col :span="2" style="text-align: right"><span>商户编号 :</span></el-col>
                    <el-col :span="1" style="text-align: left"><span>{{ TemplateData[0].CustId }}</span></el-col>
                    <el-col :span="3" style="text-align: right"><span>SerectKey :</span></el-col>
                    <el-col :span="4" style="text-align: left"><span>{{ TemplateData[0].Key }}</span></el-col>
                </el-row>
                <el-row style="margin-top: 30px">
                    <el-col :span="2" style="text-align: right"><span>子账户 :</span></el-col>
                    <el-col :span="1" style="text-align: left"><span>{{ TemplateData[0].SubAccount }}</span></el-col>
                    <el-col :span="2" style="text-align: right"><span></span></el-col>
                    <el-col :span="1" style="text-align: left"><span></span></el-col>
                    <el-col :span="2" style="text-align: right"><span></span></el-col>
                    <el-col :span="1" style="text-align: left"><span></span></el-col>
    ...
    export default {
        ...
        data() {
            return {
                TemplateData: [
                    {
                        MinPayout: 0, MaxPayout: 0, PayoutCount: 0, Retained: 0, Tax: 0, OrgNo: 0, CustId: 0, SerectKey: 0, SubAccount: 0,
                        ExtraConfig: [{ Minimum: 0, Maximum: 0, FirstExtra: 0, Extra: 0, BeginTime: 0, EndTime: 0 }],
                        ItemList: [{ SerialNumber: 0, Count: 0, Icon: 0, IsHot: 0 }],
                    }
                ],
                uploadURL: '/upload_file_grepay',
                saveURL: '/shop_config_grepay_save',
                getURL: '/shop_config_grepay',
                uploadData: { jsontype: 22 },
                isPaging: false,
            }
        },
    };
