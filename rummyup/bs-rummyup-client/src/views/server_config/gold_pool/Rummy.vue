...
export default {
    data () {
        return {
            ...
            tableData: [
                { gearID: 1000, gear: 5, min: 0, max: 0, min_gold: 0, max_gold: 0 },
                { gearID: 1001, gear: 4, min: 0, max: 0, min_gold: 0, max_gold: 0 },
                { gearID: 1002, gear: 3, min: 0, max: 0, min_gold: 0, max_gold: 0 },
                { gearID: 1003, gear: 2, min: 0, max: 0, min_gold: 0, max_gold: 0 },
                { gearID: 1004, gear: 1, min: 0, max: 0, min_gold: 0, max_gold: 0 },
                { gearID: 1005, gear: 0, min: 0, max: 0, min_gold: 0, max_gold: 0 },
                { gearID: 1006, gear: -1, min: 0, max: 0, min_gold: 0, max_gold: 0 },
                { gearID: 1007, gear: -2, min: 0, max: 0, min_gold: 0, max_gold: 0 },
                { gearID: 1008, gear: -3, min: 0, max: 0, min_gold: 0, max_gold: 0 },
                { gearID: 1009, gear: -4, min: 0, max: 0, min_gold: 0, max_gold: 0 },
                { gearID: 1010, gear: -5, min: 0, max: 0, min_gold: 0, max_gold: 0 },
            ],
            index: 0,
            gear: 0,
            goldPool: 0,
