            ...
            <el-col :span="24">
                <el-card class="box-card">
                    <el-table :data="tableData" style="100%" border>
                        ...
                        <el-table-column align="center" prop="PlayerWithPlayer" label="玩家与玩家对局"></el-table-column>
                        <el-table-column align="center" prop="PlayerWithRobot" label="玩家与AI对局"></el-table-column>
                    </el-table>
                </el-card>
    ...
    export default {
        data () {
            return {
                ...
                titleData: [],
                options: [
                    { value: 0, label: 'TeenPatti' },
                    { value: 1, label: 'QuickTP' },
                ],
                gameSelect: 'TeenPatti',
            }
        },
        created() {
        ...
        methods: {
            ...
            search() {
                ...
                if (apkId === this.gd.NoInit) {
                    ...
                    let params = { startdate, enddate, page: this.page, pageSize: this.pageSize, type: this.gameSelect };
